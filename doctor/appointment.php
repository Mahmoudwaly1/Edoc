                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                       ...
                                       <a href="chat.php" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-accebt"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Accebt</font></button> </a>
